...
const Header = () => {
  ...
  return (
    <>
      {/* Header grande (lg+) */}
      <nav className="hidden lg:flex justify-between items-center px-6 py-4 bg-white dark:bg-gray-900 dark:text-gray-200 shadow-md dark:shadow-lg fixed top-0 left-0 w-full z-50 border-b border-gray-200 dark:border-gray-700">
        <div className="max-w-screen-xl w-full mx-auto flex justify-between items-center">
          <div className="flex items-center gap-2">
            <img src={Logo} alt={t('header.title')} className="h-10 rounded-xl" />
            <div className="text-2xl font-bold text-gray-800 dark:text-white">{t('header.title')}</div>
          </div>
      ...
      {/* Header móvil (sm, md) */}
      <nav className="lg:hidden fixed bottom-0 left-0 w-full bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-700 shadow-inner z-50 py-3">
